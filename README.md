...
##### notify
* These results show only the best results for each evaluation set(Oxford5k, Paris6k, Holidays) among the results of applying the model generated during training. In other words, it is not the result of all the best evaluation sets in a particular model.
...
| 3 | resnet152 | gem  |   0.905   | 0.868  |  0.7523 | 1024 | npairs loss  |  neuralcode | imagenet |
